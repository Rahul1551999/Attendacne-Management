<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LOGIN_ADMIN.aspx.cs" Inherits="MINI_PROJECT.LOGIN_ADMIN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <link href="STYLE/ADMIN_LOGIN.css" rel="stylesheet" type="text/css" />
    <div class="container">
        <div class="row">
